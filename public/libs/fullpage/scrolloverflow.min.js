...
(function (g, q, f) {
    ...
    function u(a, b, c) {
        var e = q.createElement("div"), d = q.createElement("div");
    ...
    var t = g.requestAnimationFrame || g.webkitRequestAnimationFrame ||
        ...
        var b = {}, c = q.createElement("div").style, e = function () {
        ...
        b.momentum = function (a, b, c, e, d, k) {
            ...
            g = a + c * c / (2 * k) * (0 > b ? -1 : 1);
            k = c / k;
            g < e ? (g = d ? e - d / 2.5 * (c / 8) : e, b = f.abs(g - a), k = b / c): 0
            <
            g && (g = d ? d / 2.5 * (c / 8) : 0, b = f.abs(a) + g, k = b / c);
    ...
    p.prototype = {
        version: "5.2.0", _init: function () {
            ...
            if (this.enabled && d.eventType[a.type] === this.initiated) {
                ...
                var e = f.round(this.x), k = f.round(this.y), h = f.abs(e - this.startX),
        ...
        off: function (a, b) {
            ...
            if (this.enabled) {
                ...
                if ("deltaX" in a) 1 === a.deltaMode ? (b = -a.deltaX * this.options.mouseWheelSpeed, a = -a.deltaY * this.options.mouseWheelSpeed) : (b = -a.deltaX, a = -a.deltaY); else if ("wheelDeltaX" in a) b = a.wheelDeltaX / 120 * this.options.mouseWheelSpeed, a = a.wheelDeltaY / 120 * this.options.mouseWheelSpeed; else if ("wheelDelta" in a) b = a = a.wheelDelta / 120 * this.options.mouseWheelSpeed; else if ("detail" in a) b = a = -a.detail / 3 * this.options.mouseWheelSpeed; else return;
            ...
            var c = 0, e = this.pages.length, d = 0;
            ...
            for (; c < e; c++)if (a >= this.pages[c][0].cx) {
                a = this.pages[c][0].x;
                break
            }
            ...
            var g = this.pages[a][b].x, h = this.pages[a][b].y;
            ...
            var g = this, n = this.x, l = this.y, m = d.getTime(), q = m + c;
            this.isAnimating = !0;
            f()
    ...
    v.prototype = {
        handleEvent: function (a) {
            ...
            var b = a.touches ? a.touches[0] : a, c, e;
            d.getTime();
            ...
            var a = this.options.listenX && f.round(this.sizeRatioX * this.scroller.x) || 0, b = this.options.listenY && f.round(this.sizeRatioY * this.scroller.y) || 0;
